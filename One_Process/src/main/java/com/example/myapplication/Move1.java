...
public class Move1 extends Activity {
    ...
    private void setAnimator() {
        objectAnimator = ObjectAnimator.ofFloat(img1, "y", 0f, 370f);
        objectAnimator1 = ObjectAnimator.ofFloat(img2, "y", 0f, 370f);
        objectAnimator2 = ObjectAnimator.ofFloat(img3,"y",0f,370f);
    ...
    private void setTimer(Timer timer) {
        TimerTask timerTask = new TimerTask() {
            @Override
            public void run() {
                sendMessage(seekBar.getProgress(),img1.getY());
                if ((img1.getY() >= 365f && seekBar.getProgress()<=22)||(img1.getY()>=365f&&Math.abs(seekBar.getProgress() - 22)<=2) ||(img2.getY()>=365f&&Math.abs(seekBar.getProgress()-53)<=2)||(img3.getY()>=365f&&Math.abs(seekBar.getProgress() - 84)<=2)) {
    ...
    private void sendMessage(int progress,float Y){
        Message message = Message.obtain();
        message.what = 0x115;
        message.obj = "进度值:"+progress+"冰柱Y值:"+Y;
        handler.sendMessage(message);
